                ...
                <div class="card-body" id="hiddens">
                  ...
                  <div class="form-group ">
                    ...
                    <div>
                                ...
                                <input disabled id="nteacher" placeholder="Entrer N° sécurité sociale"  type="text" value="{{ old('nteacher', Auth::user()->nteacher) }}" class="form-control @error('nteacher') is-invalid @enderror" name="nteacher" value="{{ old('nteacher') }}" required autocomplete="nteacher" >
